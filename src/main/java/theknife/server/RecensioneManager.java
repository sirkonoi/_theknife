...
public class RecensioneManager {
    ...
    /**
     * Inserisce una nuova recensione nel database dopo aver verificato la non esistenza
     * di un'altra recensione per quel ristorante da parte dell'utente.
     * 
     * @param recensione {@link Recensione} da registrare.
     * @return true se l'inserimento ha successo, false se la recensione esiste già o in caso di errore SQL.
     */
    ...
    /**
     * Estrae una specifica recensione ricercandola attraverso la coppia id-utente e id-ristorante.
     *
     * @param idRistorante L'id del ristorante associato.
     * @param idRecensore  L'id dell'utente recensore.
     * @return {@link Recensione} se presente, null altrimenti o in caso di errore SQL.
     */
    ...
    /**
     * Restituisce la lista completa di tutte le recensioni associate a uno specifico ristorante.
     *
    ...
    public List<Recensione> getRecensioniRistorante(int idRistorante) {
        ...
        /**
     * Restituisce la lista completa di tutte le recensioni scritte da uno specifico utente.
     *
    ...
    /**
     * Calcola il numero di recensioni totali e il numero medio di stelle di un ristorante.
     *
     * @param idRistorante L'id del ristorante.
     * @return Un array di double che ha come primo elemento la media delle stelle e secondo elemento il numero complessivo di recensioni.
     */
    ...
    /**
     * Verifica se un utente abbia già scritto o meno una recensione per un dato ristorante.
     *
     * @param idRistorante L'id del ristorante.
     * @param idRecensore  L'id dell'utente.
     * @return true se l'utente ha già recensito il ristorante specificato, false altrimenti.
     */
