        ...
        try {
            while (true) {
                ...
                if (request.getOp().equals("login")) {
                    ...
                    restaurantManager.addRistorante(ris, tipiRis);
                    result = new Message("OK", new Object[] {});
                }

                else if (request.getOp().equals("deleteRistorante")) {
                    int id = (int) request.getDati()[0];
                    boolean ris = restaurantManager.deleteRistorante(id);
                ...
                else if (request.getOp().equals("rispondiRecensione")) {
                    int id = (int) request.getDati()[0];
                ...
                else if(request.getOp().equals("modifyRisposta")) {
                    int id = (int) request.getDati()[0];
                    String nuovoTesto = (String) request.getDati()[1];
                    boolean ris = recensioniManager.modifyRisposta(id, nuovoTesto);
                    if(ris) {result = new Message("OK", new Object[] {});}
                    else { result = new Message("ERROR", new Object[]{"Modifica fallita"});}
                }                    
                ...
                else if(request.getOp().equals("modifyRecensione")) {
                    int id = (int) request.getDati()[0];
                    String nuovoTesto = (String) request.getDati()[1];
                    boolean ris = recensioniManager.modifyRecensione(id, nuovoTesto);
                    if(ris) {result = new Message("OK", new Object[] {});}
                    else { result = new Message("ERROR", new Object[]{"Modifica fallita"});}
                }

                else if (request.getOp().equals("removeRecensione")) {
                    int id = (int) request.getDati()[0];
